...
import type { Tenant, Contato } from '../../types';
...
export const TenantForm: React.FC<TenantFormProps> = ({ onSuccess, onCancel, initialData }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (initialData?.id) {
                await api.put(`/tenants/${initialData.id}`, payload);
                ...
                {initialData?.apiKey && (
                    <div className="mt-4">
                        ...
                        <input type="text" readOnly
                            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm bg-gray-100 font-mono text-gray-600 cursor-default"
